...
if CLIENT then
   ...
   SWEP.Icon = "VGUI/ttt/icon_crimepanda_ak47"

   -- Text shown in the equip menu
   SWEP.EquipMenuData = {
      type = "Weapon",
      desc = "The original Kalashnikov is sure to be a helping hand."
   };
end
...
if SERVER then
   ...
   resource.AddFile("materials/VGUI/ttt/icon_crimepanda_ak47.vmt")
end
